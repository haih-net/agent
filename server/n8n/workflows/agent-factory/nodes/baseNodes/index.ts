...
import { FreeCodeMeUserDocument } from 'src/gql/generated/freeCodeMeUser'
...
const freeCodeMeUserQuery = print(FreeCodeMeUserDocument)
const freeCodeMyMindLogsQuery = print(FreeCodeMyMindLogsDocument)
